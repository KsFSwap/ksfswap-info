...
export function getPoolLink(token0Address, token1Address = null, remove = false) {
  if (!token1Address) {
    ...
    return (
      `https://ksfswap.finance/` +
      (remove ? `remove` : `add`) +
      `/${token0Address === '0x4446Fc4eb47f2f6586f9fAAb68B3498F86C07521' ? 'KCS' : token0Address}/${
        token1Address === '0x4446Fc4eb47f2f6586f9fAAb68B3498F86C07521' ? 'KCS' : token1Address
      }`
    )
  }
}
...
export function getSwapLink(token0Address, token1Address = null) {
  if (!token1Address) {
    return `https://ksfswap.finance/swap?inputCurrency=${token0Address}`
  } else {
    return `https://ksfswap.finance/swap?inputCurrency=${
      token0Address === '0x4446Fc4eb47f2f6586f9fAAb68B3498F86C07521' ? 'KCS' : token0Address
...
export function getMiningPoolLink(token0Address) {
  return `https://app.uniswap.org/#/uni/KCS/${token0Address}`
}
...
export function getUniswapAppLink(linkVariable) {
  ...
  return `${baseUniswapUrl}/KCS/${linkVariable}`
}
...
export const urls = {
  showTransaction: (tx) => `https://scan.kcc.io/tx/${tx}/`,
  showAddress: (address) => `https://scan.kcc.io/address/${address}/`,
  showToken: (address) => `https://scan.kcc.io/token/${address}/`,
  showBlock: (block) => `https://scan.kcc.io/block/${block}/`,
}
