...
const theme = (darkMode, color) => ({
  ...
  uniswapPink: darkMode ? '#14d292' : 'black',
  ...
  //primary colors
  primary1: darkMode ? '#2172E5' : '#14d292',
  ...
  // color text
  primaryText1: darkMode ? '#6da8ff' : '#14d292',

  // secondary colors
  secondary1: darkMode ? '#2172E5' : '#14d292',
  ...
  background: darkMode ? 'black' : `radial-gradient(50% 50% at 50% 50%, #14d29230 0%, #fff 0%)`,
})
